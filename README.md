...
✅ Envio de Mensagens em Grupos
    ...
    Corrigido o problema em que as mensagens enviadas em grupos eram atribuídas incorretamente ao usuário. Agora a identificação do remetente funciona conforme o esperado.

✅ Acesso a Departamentos Não Autorizados

    Resolvido o bug que permitia que alguns usuários visualizassem e interagissem com departamentos aos quais não tinham permissão. A restrição de acesso agora é aplicada corretamente.

📌 Notas Adicionais:

    Impacto: As correções garantem maior segurança e consistência na experiência do usuário.

    Compatibilidade: Mantido 100% responsivo para desktop e mobile.

💡 "Mais estável, mais seguro, mais eficiente!" 🚀
